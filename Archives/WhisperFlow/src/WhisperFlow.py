...
def create_gui():
    root = tkinter.Tk()
    root.title('File to Video / Video to File Converter')

    # Create a variable to hold the user's selection
    operation = tkinter.StringVar()

    # Create radio buttons for the user to select the operation
    tkinter.Radiobutton(root, text="Convert File to Video", variable=operation, value="file_to_video").pack()
    tkinter.Radiobutton(root, text="Convert Video to File", variable=operation, value="video_to_file").pack()
    ...
    def start_conversion():
        ...
        if operation.get() == "file_to_video":
        ...
        elif operation.get() == "video_to_file":
            file_path = filedialog.askopenfilename()
            file_extension = "zip"
            ...
            binary_data = extract_binary_data_from_video(file_path, width, height)
            ...
            tkinter.messagebox.showerror("Error", "Please select an operation.")

    # Create a start button
    start_button = tkinter.Button(root, text="Start Conversion", command=start_conversion)
    start_button.pack()
